...
#ifndef DYNAMIC_GL_API_H_INCLUDED
...
#define DYNAMIC_GL_CONSTANTS \
        ...
        DYNAMIC_GL_CONSTANT(INT)\
        DYNAMIC_GL_CONSTANT(UNSIGNED_INT)\
        DYNAMIC_GL_CONSTANT(FLOAT)\
        DYNAMIC_GL_CONSTANT(DOUBLE)\
        \
...
#define DYNAMIC_GL_FUNCTIONS \
        ...
        DYNAMIC_GL_FUNCTION(Ortho,(GLdouble,GLdouble,GLdouble,GLdouble,GLdouble,GLdouble))\
...
#endif /*DYNAMIC_GL_API_H_INCLUDED*/
